...
class PaskibraView extends GetView<PaskibraController> {
  const PaskibraView({super.key});
                ...
                child: Column(
                  ...
                  children: [
                          ...
                          Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  'Paskibra adalah ekstrakurikuler yang melatih siswa menjadi pengibar bendera yang andal, dengan penekanan pada kedisiplinan dan kerja sama tim..',
                    ...
                    GridView.count(
                      ...
                      crossAxisSpacing: 15,
                      mainAxisSpacing: 15,
                      childAspectRatio: 2.2, // Make boxes smaller/wider
                      children: [
                        // Jadwal box
                        _buildInfoBox(
                          context: context,
